 ...
 */ 
 ...
 $request = array(
    ...
    "paymentRequest.merchantAccount" => "BRPRHolding",   
	"paymentRequest.amount.currency" => "EUR",
	"paymentRequest.amount.value" => "99",
	"paymentRequest.reference" => "TEST-PAYMENT-" . date("Y-m-d-H:i:s"),
	"paymentRequest.shopperIP" => $_SERVER['REMOTE_ADDR'],
	"paymentRequest.shopperEmail" => "mike@redmelon.nl",
	"paymentRequest.shopperReference" => "M de Vries",
 ...
 curl_setopt($ch, CURLOPT_USERPWD, "admin:lopK87226x");   
